...
class ListenTwo extends StatelessWidget {
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Future<String> loadAsset() async {
    return await rootBundle.loadString('assets/school.txt');
  }
  @override
  Widget build(BuildContext context) {
    return WillPopScope(
        onWillPop: ()async{
          Read("Mp3/school.mp3", false);
