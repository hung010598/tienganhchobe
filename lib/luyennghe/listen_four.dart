...
class ListenFour extends StatelessWidget {
...
class _StatefulWidgetDemoState extends State<MyHomePage> {
                            ...
                            children: <Widget>[
                               ...
                               new Row(
                                ...
                                children: <Widget>[
                                  new GestureDetector(
                                    onTap: () async{
                                      Read("Mp3/animal.mp3", true);
                                    },
                                    child: new Image.asset("assets/play.png"),
                                  ),
                                  new GestureDetector(
                                    onTap: () async{
                                      Read("Mp3/animal.mp3", false);
                                    },
  ...
  Future<String> loadAsset() async {
    return await rootBundle.loadString('assets/animal.txt');
  }
}