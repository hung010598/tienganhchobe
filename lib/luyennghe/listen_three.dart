...
class ListenThree extends StatelessWidget {
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Future<String> loadAsset() async {
    return await rootBundle.loadString('assets/flower.txt');
  }
  @override
  Widget build(BuildContext context) {
                            ...
                            children: <Widget>[
                             ...
                             new Row(
                              ...
                              children: <Widget>[
                                new GestureDetector(
                                  onTap: () async{
                                    Read("Mp3/flower.mp3", true);
                                  },
                                  child: new Image.asset("assets/play.png"),
                                ),
                                new GestureDetector(
                                  onTap: () async{
                                    Read("Mp3/flower.mp3", false);
                                  },
