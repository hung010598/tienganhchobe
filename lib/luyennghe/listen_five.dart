...
class ListenFive extends StatelessWidget {
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Future<String> loadAsset() async {
    return await rootBundle.loadString('assets/house.txt');
  }
  @override
  Widget build(BuildContext context) {
                          ...
                          child: new Column(
                              ...
                              new Row(
                                ...
                                children: <Widget>[
                                  new GestureDetector(
                                    onTap: () async{
                                      Read("Mp3/house.mp3", true);
                                    },
                                    child: new Image.asset("assets/play.png"),
                                  ),
                                  new GestureDetector(
                                    onTap: () async{
                                      Read("Mp3/house.mp3", false);
                                    },
