...
class ListenSeven extends StatelessWidget {
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Future<String> loadAsset() async {
    return await rootBundle.loadString('assets/fruit.txt');
  }
  @override
  Widget build(BuildContext context) {
    return new WillPopScope(
        onWillPop: () async {
          Read("Mp3/fruit.mp3", false);
